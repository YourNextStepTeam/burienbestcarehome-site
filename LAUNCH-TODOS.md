...
## Becca to do — Google Business Profile

- [ ] Register / claim the **Google Business Profile** at https://business.google.com using the canonical NAP that now ships on the site: "Burien Best Care Home" / `927 SW 132nd St, Burien, WA 98146` / `(253) 678-7089`. This is the single biggest move for Map Pack visibility — the on-site schema is necessary but not sufficient. Verify the listing by postcard or phone, set business hours to 24/7, and link the website to the live `.com` domain.
